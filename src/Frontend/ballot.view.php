...
<div id="webPollBallot"><!-- pollLanguage -->
  ...
  <form class="web-poll-ballot-container">
    <div class="web-poll-ballot-candidate-container">
      ...
      <label for="WebPoll_yes">Yes, I do</label>
      <!-- Add info icon <span>ⓘ</span> &#9432; -->
    </div>
    <div class="web-poll-ballot-candidate-container">
      <input type="radio" id="WebPoll_no" class="web-poll-vote" name="web-poll-vote" value="No, I don't"> 
      <label for="WebPoll_no">No, I don't</label>
      <!-- Add info icon <span>ⓘ</span> &#9432; -->
    </div>
  </form>
</div>
